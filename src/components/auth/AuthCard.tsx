 ...
 * No card border — form floats on white background.
 */
export function AuthCard({ children, title, description }: AuthCardProps) {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Top bar */}
      <header className="h-14 flex items-center px-6 border-b border-[#E4E4E7]">
      ...
      <footer className="h-10 flex items-center justify-center text-xs text-[#A1A1AA] border-t border-[#E4E4E7]">
